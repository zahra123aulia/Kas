                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2" style="margin-top: 3%;">
                            <div class="mb-3">
                                ...
                                <button type="reset" onclick="location.href='?page=laporan_kas_masuk'" class="btn btn btn-primary"><i class="fa fa-retweet" aria-hidden="true"></i></button>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="card-body">
                ...
                <div class="text-center">
                    ...
                    if (!empty($_POST['tanggalAwal'])) {
                        ?>
                        <a href="cetak_kas_masuk.php?tanggalAwal=<?php echo $tanggalAwal ?>&tanggalAkhir=<?php echo $tanggalAkhir ?>" class="btn btn-success btn-sm mb-3" target="_blank">Print</a>
                        <?php
                     }else{
                     }
                    ?>
...
<script>
    let table = new DataTable('#kas_masuk');
</script> 